...
//const calendarRestApi: string = calendarData.SiteUrl.trim()
//+ '/_api/Web/Lists/GetByTitle(\'' + calendarData.CalendarListTitle.trim() + '\')/items?$filter=Category eq \''+ calendarData.CalendarFilter+'\'';
      ...
      eventSourcesArray.push({
        events: ((start: moment.Moment, end: moment.Moment, timezone, callback) => {
          ...
          dataService.getEventsForCalendar(calendarRestApi, calendarData.Color, startDate, endDate, calendarData.CalendarFilter )
